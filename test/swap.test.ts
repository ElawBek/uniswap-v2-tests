...
describe("APP", () => {
  ...
  describe("Swap", () => {
    beforeEach(async () => {
      ...
      PairERCtoERCfee = new UniswapV2Pair__factory().attach(
        createdPairTokenAndTokenWithFee
      );
    ...
    it("Swap ETH for exact TKN1", async () => {
      ...
      const amounts = await Router.getAmountsIn(parseEther("123"), [
        WETH.address,
        TokenOne.address,
      ]);
    ...
    it("Swap exact TKN2 for TWF", async () => {
      ...
      await expect(() =>
        ...
        tokenWithFee,
        userOne,
        parseEther("199.038385095234383898")
      );
    ...
    it("Swap exact ETH for TWF", async () => {
      ...
      await expect(() =>
        ...
        tokenWithFee,
        userOne,
        parseEther("157.812484101006181823")
      );
